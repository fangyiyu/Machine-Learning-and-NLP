...
This repository contains documentation I made while learning Machine Learning and Artificial Intelligence; it mainly consists of three parts: the source code for fundamental machine learning algorithms in python, including two main genres: logistic regression and tree-based algorithms; theoretical concepts behind machine learning, as well as natural language processing, which include but are not limited to the underlying mathematical manipulations and implementations. The notebooks are organized by resources from multiple online platforms, such us literature publications, Medium, CSDN, StackOverflow, ZhiHu, etc.
...
# 2. [Notebook for Machine learning](https://github.com/fangyiyu/Machine_Learning_Source_code/blob/master/Machine%20Learning.pdf)

# 3. [Notebook for Natural Language Processing](https://github.com/fangyiyu/Machine_Learning_Source_code/blob/master/NLP_Theories.pdf)
